-- Fix Expenses Table Column Mismatch
...
-- 3. Add unique constraint to expense_number
ALTER TABLE public.expenses ADD CONSTRAINT IF NOT EXISTS expenses_expense_number_key UNIQUE (expense_number);
